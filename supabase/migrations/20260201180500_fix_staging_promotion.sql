...
-- Fixes the scalar array error from the previous attempt.
...
begin
  ...
  for r in select * from staging_country_research loop
    ...
    values (
      ...
      'published',
      array[r.payload->'country'->>'region'], -- Fixed: Treat region as single string -> array
      null,
      r.payload->'pathways'->0->'income_requirement'->>'currency',
      null,
      null,
    ...
    on conflict (iso2) do update set
      ...
      regions = excluded.regions, -- Update regions on conflict
